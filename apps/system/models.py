...
class Menu(models.Model):
    ...
    parent = models.ForeignKey("self", null=True, blank=True, verbose_name="父菜单", on_delete=models.DO_NOTHING)
...
class Structure(models.Model):
    ...
    parent = models.ForeignKey("self", null=True, blank=True, verbose_name="父类架构", on_delete=models.DO_NOTHING)
...
class UserProfile(AbstractUser):
    ...
    department = models.ForeignKey("Structure", null=True, blank=True, verbose_name="部门", on_delete=models.DO_NOTHING)
    post = models.CharField(max_length=50, null=True, blank=True, verbose_name="职位")
    superior = models.ForeignKey("self", null=True, blank=True, verbose_name="上级主管", on_delete=models.DO_NOTHING)
